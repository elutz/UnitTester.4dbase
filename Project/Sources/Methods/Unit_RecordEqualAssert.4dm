...
// Date and time: 04/01/09, 20:17:39
//--------------------------------------------------------------------------------
// Method: Unit_RecordEqualAssert
// Takes a table pointer and two record numbers as inputs 
// and compares all field values for equality. 
//
//--------------------------------------------------------------------------------
//
//Return Value
...
Unit_EqualAssert(->$val1_blob; ->$val2_blob; $other_t)
